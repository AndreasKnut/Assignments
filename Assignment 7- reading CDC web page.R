...
#read all of the data and make a new variable Year.
...
# Turn all of the data to csv to reduce the sice of the datasets.
write.csv(birth2017,"birth2017.csv")
birth2017csv<-read_csv("birth2017.csv")

write.csv(birth2018,"birth2018.csv")
...
#Combinde these datasets and plot.
...
#Finding the number of boys and girls born each day.
